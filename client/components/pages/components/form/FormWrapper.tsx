...
export const fs = {
  ...
  form: "mt-1 text-black dark:text-white px-2 py-1 text-opacity-80 bg-transparent block w-full rounded-md border-2 shadow-sm focus:border-[#dc6bf5] focus:ring focus:ring-[#dc6bf5] focus:ring-opacity-50",
  button:
